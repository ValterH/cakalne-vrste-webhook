...
def izberi_poseg(group):
    groups = {'head scan':["CT glave(kontrast)",
              ...
              'operation':["Operacija abdominalne aorte",
                           "Operacija anusa",
                           "Operacija discus hernie",
                           "Operacija Dupuytrenove kontrakture",
                           "Operacija hidrokele / spermatokele / varikokele",
                           "Operacija hrbtenice - dekompresija",
                           "Operacija hrbtenice - spondilodeza",
                           "Operacija ileusa - razrešitev zarastlin",
                           "Operacija jeter",
                           "Operacija karpalnega kanala",
                           "Operacija kile",
                           "Operacija krčnih žil",
                           "Operacija morbidne debelosti",
                           "Operacija nosnega pretina",
                           "Operacija nožnega palca (hallux)"
                           "Operacija pankreasa",
                           "Operacija pankreasa z duodenektomijo",
                           "Operacija prirojene napake prepone (diafragmalna kila,?)",
                           "Operacija prirojenih anomalij hrbtenjače in hrbteničnega kanala (meningokela, mielomeningokela,?)",
                           "Operacija sečevoda (vezikouretralni refluks, hidronefroza, ?)",
                           "Operacija sive mrene (katarakte)",
                           "Operacija skolioze",
                           "Operacija slepiča (apendiksa)",
                           "Operacija strabizma",
                           "Operacija tireoglosalne ciste/fistule",
                           "Operacija torakalne anevrizme",
                           "Operacija tumorja na hrbtenici",
                           "Operacija ženske urinske inkontinence (razen TVT)",
                           "Operacija ženske urinske inkontinence TVT",
                           "Operacija žolčnih kamnov",
                           "Operacija žolčnikov in žolčevodov (razen žolčnih kamnov)",
                           "Operacije glavkoma",
                           "Operacije malignih tumorjev  v otorinolaringologiji (ORL) in maksilofacialni kirurgiji  v splošni anesteziji"
                           "Ortopedska operacija rame",
                           "Revizijska operacija kolena",
                           "Revizijska operacija kolka",
                           "Revizijska operacija ramena",
                           "Torakoskopska operacija pljuč"]
              }
    res = "izberi:\n"
